...
export const resumeData = {
  ...
  summary: {
    ...
    paragraphs: [
      "저는 9년간 프론트엔드 기술을 중심으로 제품의 완성도를 높이고 최적의 사용자 경험을 제공하기 위해 고민해 왔습니다. 단순히 기능을 구현하는 것을 넘어 <b>디자인 시스템 구축을 통한 UI 표준화</b>, 서비스 특성에 맞춰 <b>SEO 및 초기 진입 경험을 개선하기 위한 SSR(React Router v7) 도입</b>, 그리고 <b>슈퍼앱 플랫폼 코어 SDK 개발 리딩</b> 등 다양한 기술적 도전이 실제 서비스의 성장으로 이어지는 과정을 주도해 왔습니다.",
